const translations = {
    uz_lt: {
        ...
        nav_contact: "Aloqa",
        nav_donate: "Xayriya",
        hero_title: "G'OYIB YORONLAR<br>JOME MASJIDI",
        hero_title_inline: "\"G'OYIB YORONLAR\" JOME MASJIDI",
        ...
        news_demo_title1: "\"G'oyib Yoronlar\" jome masjidi yangiliklari",
        news_demo_title2: "Juma ma'ruzasi: Iymon halovati",
        ...
        electric_payment_note: "<span style=\"font-weight: 600; color: #d97706;\"><i class=\"fas fa-info-circle\" style=\"margin-right:5px;\"></i>Qanday to'lash kerak?</span><br>Bu — <strong>yuridik hisob raqam</strong>. Payme ilovasidan to'lash uchun:<br><strong>Kommunal to'lovlar</strong> → <strong>Elektr energiyasi (yuridik)</strong> → hisob raqamni kiriting.",
        util_elec: "Elektr energiyasi",
        util_water: "Suv",
        util_gas: "Gaz",
        util_trash: "Chiqindi",
        util_wifi: "Wi-Fi",
        domo_card_title: "Domo.uz orqali ehson",
        domo_card_desc: "Masjidimizga xayriya qilish uchun domo.uz platformasidan ham foydalanishingiz mumkin. Karta kerak emas — har qanday to'lov tizimidan.",
        domo_card_btn: "domo.uz dan ehson qilish",
    ...
    uz_cy: {
        ...
        nav_contact: "Алоқа",
        nav_donate: "Хайрия",
        hero_title: "\"ҒОЙИБ ЁРОНЛАР\"<br>ЖОМЕ МАСЖИДИ",
        hero_title_inline: "\"ҒОЙИБ ЁРОНЛАР\" ЖОМЕ МАСЖИДИ",
        ...
        news_demo_title1: "\"Ғойиб Ёронlar\" жоме масжиди янгиликлари",
        news_demo_title2: "Жума маърузаси: Иймон ҳаловати",
        ...
        electric_payment_note: "<span style=\"font-weight: 600; color: #d97706;\"><i class=\"fas fa-info-circle\" style=\"margin-right:5px;\"></i>Қандай тўлаш керак?</span><br>Бу — <strong>юридик ҳисоб рақам</strong>. Payme иловасидан тўлаш учун:<br><strong>Коммунал тўловлар</strong> → <strong>Электр энергияси (юридик)</strong> → ҳисоб рақамни киритинг.",
        util_elec: "Электр энергияси",
        util_water: "Сув",
        util_gas: "Газ",
        util_trash: "Чиқинди",
        util_wifi: "Wi-Fi",
        domo_card_title: "Domo.uz орқали эҳсон",
        domo_card_desc: "Масжидимизга хайрия қилиш учун domo.uz платформасидан ҳам фойдаланишингиз мумкин. Карта керак эмас — ҳар қандай тўлов тизимидан.",
        domo_card_btn: "domo.uz дан эҳсон қилиш",
    ...
    ru: {
        ...
        hero_title: "СОБОРНАЯ МЕЧЕТЬ<br>«ГОЙИБ ЁРОНЛАР»",
        hero_title_inline: "СОБОРНАЯ МЕЧЕТЬ «ГОЙИБ ЁРОНЛАР»",
        hero_subtitle: "Наманганская область, Папский район, село Туда",
        hero_desc: "Обитель духовности и свет веры",
        ...
        news_demo_title1: "Новости соборной мечети «Гойиб Ёронлар»",
        news_demo_title2: "Пятничная проповедь: Сладость веры",
        news_demo_desc: "Эти новости в будущем будут автоматически добавляться через Telegram бота.",
        about_title: "О нас",
        ...
        electric_payment_note: "<span style=\"font-weight: 600; color: #d97706;\"><i class=\"fas fa-info-circle\" style=\"margin-right:5px;\"></i>Как оплатить?</span><br>Это — <strong>юридический счёт</strong>. Оплата через Payme:<br><strong>Коммунальные платежи</strong> → <strong>Электроэнергия (юридический)</strong> → введите номер счёта.",
        util_elec: "Электроэнергия",
        util_water: "Вода",
        util_gas: "Газ",
        util_trash: "Мусор",
        util_wifi: "Wi-Fi",
        domo_card_title: "Пожертвовать через Domo.uz",
        domo_card_desc: "Вы также можете сделать пожертвование для нашей мечети через платформу domo.uz. Карта не нужна — с помощью любой платёжной системы.",
        domo_card_btn: "Пожертвовать через domo.uz",
    ...
    en: {
        ...
        hero_title_inline: "G'OYIB YORONLAR JOME MOSQUE",
        ...
        news_demo_title1: "News from G'oyib Yoronlar jome mosque",
        news_demo_title2: "Friday sermon: The sweetness of faith",
        ...
        electric_payment_note: "<span style=\"font-weight: 600; color: #d97706;\"><i class=\"fas fa-info-circle\" style=\"margin-right:5px;\"></i>How to pay?</span><br>This is a <strong>legal account number</strong>. To pay via Payme:<br><strong>Utility payments</strong> → <strong>Electricity (legal)</strong> → enter the account number.",
        util_elec: "Electricity",
        util_water: "Water",
        util_gas: "Gas",
        util_trash: "Waste",
        util_wifi: "Wi-Fi",
        domo_card_title: "Donate via Domo.uz",
        domo_card_desc: "You can also make a donation for our mosque through the domo.uz platform. No card needed — use any payment system.",
        domo_card_btn: "Donate via domo.uz",
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateClock() {
        ...
        if (currentLang === 'uz_lt') {
            dateString = `${uzDays[now.getDay()]}, ${now.getDate()}-${uzMonths[now.getMonth()]} ${now.getFullYear()}-yil`;
        } else if (currentLang === 'uz_cy') {
            dateString = `${uzCyDays[now.getDay()]}, ${now.getDate()}-${uzCyMonths[now.getMonth()]} ${now.getFullYear()}-йил`;
        } else if (currentLang === 'ru') {
            const options = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
            dateString = now.toLocaleDateString('ru-RU', options);
    ...
    async function loadApiTimes() {
        try {
            ...
            // Redirect muammosini oldini olish uchun sanani to'g'ridan-to'g'ri beramiz
